...
In this task you will create a Sophos XG Virtual Appliance which will emulate an on-premises device.  The layout of this is depicted in the diagram below
...
1.  Go to **VPN > IPsec Connections**, select **Add **and configure the following settings:
    ...
    **Gateway Settings Section**:
      ...
      - **Local Subnet**: Click **Add new item**, click **Create new**, and configure the settings in the following graphic


      ![Screenshot](../Media/Module-2/947ea166-090d-4253-b5d3-f25b627e1b05.png)

      - **Remote Subnet**: Click **Add new item**, click **Create new**, and configure the settings in the following graphic
</br>
